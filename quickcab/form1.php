...
function quickcab_render_quickcab_form_shortcode($options) {
  ...
  /* ==== line 19 thru 24 is where custom notice fields were added - Larry 14/09/2023 */ 
  $extquick_message_two = ('' !=( get_option('extend_quickcab_options')['extend_quickcab_message_two']))
    ? get_option('extend_quickcab_options')['extend_quickcab_message_two'] 
    : '';
  $extquick_message_three = ('' !=( get_option('extend_quickcab_options')['extend_quickcab_message_three']))
          ...
          <div class="quickcab-input-group">
            ...
            if ( $booking_form->enable_direction_field() ) {
              ?><div class="quickcab-input-row">
                ...
                <?php /* ==== line 108 is where custom notice fields were added - Larry 14/09/2023 */ ?>                
                <h5 class="direction-notice-reminder notice">&nbsp;<?php echo $extquick_message_two; /* esc_html__('Seleziona quale direzione prenotare?', 'quickcab'); */ ?></h5>
                <h5 class="direction-notice-reminder warning">&nbsp;<?php echo $extquick_message_three;/* esc_html__('Se non si tratta di un viaggio di sola andata, seleziona Ritorna adesso.', 'quickcab'); */ ?></h5>
              </div><?php
            }
